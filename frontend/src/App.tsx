...
class App extends Component<Props, Cells> {
  ...
  getInstr(finishchoosecard: boolean, currplayer: String, currworker: number, finishinitpos: boolean,
           action: String, winner: String | undefined) {
      if (winner === undefined) {
